        ...
        <a class="nav-link" href="../student/student-index.php">
          ...
          <span class="menu-title">Dashboard</span>
					...
					<li class="nav-item">
						...
						<i class="fa fa-address-book mr-2" aria-hidden="true"></i> Student Result
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="../student/student-transcript.php">
						<span data-feather="users"></span>
						<i class="fa fa-check-circle mr-2" aria-hidden="true"></i> Student Transcript
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="../student/student-fee.php">
						<span data-feather="users"></span>
						<i class="fa fa-users mr-2" aria-hidden="true"></i> Student Fees
						</a>
					</li>
					<li class="nav-item">
