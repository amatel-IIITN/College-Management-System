...
<div class="main-panel">
	...
	<div class="sub-main">
				<div class=" bg-primary text-center d-flex flex-wrap flex-md-nowrap pt-3 pb-2 mb-3 text-white admin-dashboard pl-3">
					<div class="d-flex">
						<h3 class="mr-5">Teacher Management System </h2>
				...
				<section class="mt-3">
					...
					<div class="col-md-12">
						<!--<div class="col-md-3 offset-9 pt-5 mb-2">-->
							<!-- Large modal -->
							<button type="button" class="btn btn-info ml-auto" data-toggle="modal" data-target=".bd-example-modal-lg">Add Teacher</button>
							<button type="button" class="btn btn-info ml-auto" data-toggle="modal" data-target=".bd-example-modal-lg1">Assign Subjects</button>
					...
					<div class="card">
						<div class="card-body">
							...
							<div class="table-responsive pt-3">
								<table class="table table-bordered table-hover w-100 table-elements mb-5 table-three-tr" cellpadding="10">
									<tr class="table-tr-head bg-dark table-black table-three text-light">
										<th>Teacher ID</th>
										<th>Teacher Name</th>
