...
<div class="content-wrapper">
	<div class="sub-main">
		<div class="text-center d-flex flex-wrap flex-md-nowrap pt-3 pb-2 mb-3 text-white bg-primary admin-dashboard pl-3">
			<div class="d-flex">
				<h3 class="mr-5">Teacher Salary Management System </h4>
		...
		<div class="row">
			<div class="col-md-12">
			<button type="button" class="btn btn-info ml-auto" data-toggle="modal" data-target=".bd-example-modal-lg">Add Salary Scale</button>
				<!--<button type="button" class="btn btn-info ml-auto" data-toggle="modal" data-target=".add_salary">Add Salary</button>-->
</div>
									...
									<div class="table-responsive pt-3">
										<table class="w-100 table-bordered table-hover table-elements table-three-tr" cellpadding="3">
											<tr class="table-tr-head table-three text-black">
												<td colspan="9" class=" text-center text-black">
													<h4>All Teachers Salary Report</h4>
												</td>
											</tr>
											<tr class="table-tr-head bg-dark text-white">
