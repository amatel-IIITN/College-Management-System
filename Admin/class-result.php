...
<div class="content-wrapper">
	<div class="sub-main">
		<div class="bar-margin text-center d-flex flex-wrap flex-md-nowrap pt-3 pb-2 mb-3 text-white bg-primary admin-dashboard pl-3">
			<h3>Result Management System </h4>
			<!--<a class="btn btn-outline-info ml-auto mr-2 bg-info text-white" href="add-single-student-results.php">Single Student Result</a>-->
		</div>
		<div class="col-md-12">
		<a class="btn ml-auto bg-info text-white" href="add-single-student-results.php">Single Student Result</a>
</div>
		<div class="row">
			<div class="col-md-12">
				<div class="col-md-12">
				...
				<form action="class-result.php" method="post">
					<div class="row mt-3">
						...
						<div class="col-md-4">
							<input type="submit" name="submit" class="btn btn-info px-5" value="Press">
						</div>
					</div>
				</form>
			</div>
					...
					<div class="card">
						<div class="card-body">
							<div class="table-responsive pt-3">
								<table class="w-100 table-elements table-hover table-three-tr" cellpadding="3">
