...
?>
   <div class="content-wrapper">
	<div class="container  mt-1 border border-secondary mb-1">
		<div class="row text-white bg-info pt-5">
			<div class="col-md-4">
		...
		<div class="row pt-3">
			<div class="col-md-4">
				<h5>Phone No:</h5> <?php echo $row['other_phone']  ?>
			</div>
			<div class="col-md-4">
				<h5>State:</h5> <?php echo $row['state']  ?>
			</div>
			<div class="col-md-4">
				<h5>Last Qualification:</h5> <?php echo $row['last_qualification']  ?>
			</div>
		</div>
		<div class="row pt-3">
			<div class="col-md-4">
				<h5>Permanent Adress:</h5> <?php echo $row['permanent_address']  ?>
			</div>
			<div class="col-md-4">
		...
		<div class="row pt-3">
			<div class="col-md-4">
				<h5>MA Complition Date:</h5> <?php echo $row['ma_complition_date']  ?>
			</div>
			<div class="col-md-4">
				<h5>MA Awarded Date:</h5> <?php echo $row['ma_awarded_date']  ?>
			</div>
			<div class="col-md-4">
				<h5>MA Certificate:</h5> <?php echo $row['ma_certificate']  ?>
			</div>
		</div>
	</div>
<?php } ?>
