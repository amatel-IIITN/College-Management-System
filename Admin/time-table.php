...
<div class="content-wrapper">
	<div class="sub-main">
		<div class="text-center bg-primary d-flex flex-wrap flex-md-nowrap pt-3 pb-2 mb-3 text-white admin-dashboard pl-3">
			<div class="d-flex">
				<h3 class="mr-5">Time Table Management System </h4>
		...
		<div class="row">
			<div class="col-md-12 ml-2">
				<section class=" mt-3">
					...
					<div class="row">
						<div class="col-md-12">
						<button type="button" class="btn btn-info ml-auto" data-toggle="modal" data-target=".bd-example-modal-lg">Add Time Table</button>
						<button type="button" class="btn btn-info ml-auto" data-toggle="modal" data-target=".bd-example-modal-lg1">Update</button>
							<div class="card">
								<div class="card-body">
									<div class="table-responsive pt-3">
										<table class="w-100 table-bordered table-hover table-elements table-three-tr" cellpadding="3">
											<tr class="table-tr-head table-three text-black">
												<td colspan="6" class="text-center text-black">
