		...
		<div class="content-wrapper">
			...
			<div class="sub-main">
				<div style="align-items: center;" class="text-center bg-primary d-flex flex-wrap flex-md-nowrap pt-3 pb-2 mb-3 text-white admin-dashboard pl-3">
					<div class="d-flex">
						<h3 class="mr-5">Student Management System </h2>
					...
					<div class="col-md-12 ml-2">
						<section class="mt-3">
							<div class="row">
								...
								<div class="col-md-12">
									<!-- Large modal -->
									<button type="button" class="btn btn-info ml-auto" data-toggle="modal" data-target=".bd-example-modal-lg">Add Student</button>
									<button type="button" class="btn btn-info ml-auto" data-toggle="modal" data-target=".bd-example-modal-lg1">Assign Subjects</button>
									<a class="btn btn-info" href="asign-single-student-subjects.php"> Assign Single Student Subject</a>
							...
							<table class="w-100  pt-3 table-elements mb-5 table-hover table-bordered table-three-tr text-center" cellpadding="10">
								<tr class="table-tr-head table-three text-light bg-dark">
									<th>Roll.No</th>
									<th>Student Name</th>
