...
?>
	...
	<!-- title of this page -->
		...
		<!--<main role="main" class="col-xl-10 col-lg-9 col-md-8 ml-sm-auto px-md-4 mb-2 w-100">-->
			<div class="sub-main">
				<div class="bar-margin bg-primary text-center d-flex flex-wrap flex-md-nowrap pt-3 pb-2 mb-3 text-white admin-dashboard pl-3">
					<h3>Assign Subject to Single Student </h4>
				</div>
				<div class="row">
					<div class="col-md-12">
					<div class="col-md-12">
				...
				<div class="row">
					<div class="col-md-12 ml-2">
						<section class="border mt-3">
							<table class="w-100 table-elements table-hover table-bordered table-three-tr" cellpadding="3">
								...
								?>
								        <input class="btn btn-info px-5" type="submit" name="sub">
										<!--<input type="submit" name="submit" class="btn btn-info px-5" value="Press">-->
								    </form>
							</table>				
						</section>
