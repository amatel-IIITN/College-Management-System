        ...
        <div class="login-padding mt-6">
            ...
            <form class="p-1" action="login.php" method="POST">
                ...
                <div class="form-group text-center mb-3 mt-4">
                    <input class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" type="submit" name="btnlogin" value="LOGIN" class="btn btn-white pl-5 pr-5 ">
                </div>
            </form>
        </div>
    </div>
