...
<!---------------- Session Ends form here ------------------------>
		...
		<!--<main role="main" class="col-xl-10 col-lg-9 col-md-8 ml-sm-auto px-md-4 mb-2 w-100">-->
			<div class="sub-main">
			<!--<div class="collapse show mt-2" id="collapseeight">-->
				<div class="btn btn-block text-center bg-light d-flex flex-wrap flex-md-nowrap pt-3 pb-2 mb-3 text-dark admin-dashboard pl-3">
					<h3 class="">Welcome To <?php $roll_no=$_SESSION['LoginStudent'];
					...
					?> Dashboard </h3> </h4>
				<!--<a href="" class="ml-auto" data-toggle="collapse" data-target="#collapseeight"><i class="fa fa-plus text-light" aria-hidden="true"></i></a>-->
				</div>
				<div class="row">
					<div class="col-lg-6 col-md-12 col-sm-12">
						<div>
						<section class="mt-3">
								<div class="btn btn-block bg-info table-two text-light d-flex">
									<span class="font-weight-bold"><i class="fa fa-file-text-o mr-3" aria-hidden="true"></i>Subjects Details</span>
								...
								<div class="collapse show mt-2" id="collapseOne">
									<table class="w-100 table-elements table-bordered table-hover table-two-tr"cellpadding="2">
										<tr class="pt-5 table-two bg-dark text-light" style="height: 32px;">
											<th>Subject Code</th>
											<th>Subject Name</th>
											<th>Semester</th>
											<th>Credit Hours</th>
					...
					<div class="col-lg-6 col-md-12 col-md-6 col-sm-12">
						<div>
							<section class="mt-3">
								<div class="btn btn-block table-three bg-info text-light d-flex">
								...
								<div class="collapse show mt-2" id="collapsetwo">
									<table class="w-100 table-hover table-bordered table-elements table-three-tr"cellpadding="2">
										<tr class="pt-5 bg-dark table-three text-light" style="height: 32px;">
											<th>Voucher No.</th>
											<th>Roll No.</th>
											<th>Amt (Rs.)</th>
											<th>Posting Date</th>
				...
				<div class="row">
					<div class="col-lg-6 col-md-12 col-sm-12">
						<div>
							<section class="mt-4">
								<div class="btn btn-block table-five bg-info text-light d-flex">
								...
								<div class="collapse show mt-2" id="collapsethree">
									<table class="w-100 table-hover table-bordered table-elements table-five-tr"cellpadding="2">
										<tr class="pt-5 bg-dark table-five text-light" style="height: 32px;">
											<th>Subject code</th>
											<th>Subject Name</th>
											<th>Semester</th>
											<th>Marks</th>
					...
					<div class="col-lg-6 col-md-12 col-sm-12">
						<div>
							<section class="mt-4">
								<div class="btn btn-block table-one bg-info text-light d-flex">
								...
								<div class="collapse show mt-2" id="collapsefour">
									<table class="w-100 table-hover table-bordered table-elements table-one-tr"cellpadding="2">
										<tr class="pt-5 bg-dark table-one text-light" style="height: 32px;">
											<th>Roll No</th>
											<th>Present</th>
											<th>Absent</th>
											<th>Percentage</th>
