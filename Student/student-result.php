		...
		<!--<main role="main" class="col-xl-10 col-lg-9 col-md-8 ml-sm-auto px-md-4 mb-2 w-100">-->
			<div class="sub-main">
				...
				<div class="row">
					<div class="col-md-12">
						<section class="mt-3">
							<table class="w-100 table-hover table-bordered table-elements mb-5 table-three-tr" cellpadding="10" >
								<tr class="text-center bg-dark text-light table-three table-tr-head">
									<th>Term</th>
									<th>Course</th>
									<th>Subject</th>
									<th>Cr.Hr</th>
