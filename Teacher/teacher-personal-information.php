...
?>
		...
		<div class="content-wrapper">
			<div class="sub-main">
				<div class="text-center bg-primary d-flex flex-wrap flex-md-nowrap pt-3 pb-2 mb-4 text-white admin-dashboard pl-3">
						...
						<?php } ?>
							<div class="row">
								<div class="col-md-6 offset-3 mt-3">
									<button type="submit" name="sub" class="btn btn-info">Update Information</button>
								</div>
							</div>
						</form>
					</div>
