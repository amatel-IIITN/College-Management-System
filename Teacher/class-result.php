			...
			<div class="sub-main">
					...
					<div class="col-md-12">
						<form action="class-result.php" method="post">
							<div class="row mt-3">
								...
								<div class="col-md-6">
									<input type="submit" name="submit" class="btn btn-info" value="Press">
								</div>
							</div>	
						</form>
					</div>
				...
				<div class="row">
					<div class="col-md-12 ml-2">
						<section class="mt-3">
							<table class="w-100 table-elements table-hover table-bordered table- mb-5 table-three-tr"cellpadding="5" >
								<tr class="table-tr-head bg-dark text-white table-three">
									<th>Sr.No</th>
									<th>Roll No</th>
									<th>Cource Name</th>
									<th>Subject Name</th>
