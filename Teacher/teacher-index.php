...
?>
		...
		<!--<main role="main" class="col-xl-10 col-lg-9 col-md-8 ml-sm-auto px-md-4 main-background mb-2 w-100">-->
			<div class="sub-main">
				...
				<div class="text-center bg-light d-flex flex-wrap flex-md-nowrap pt-3 pb-2 mb-3 text-dark admin-dashboard pl-3">
					<h3 class="">Welcome To <?php $roll_no=$_SESSION['LoginTeacher'];
				...
				<div class="row">
					<div class="col-lg-9 col-md-12 grid-marginF">
						<div>
							<section class="mt-3">
							...
							<!-- <p class="card-description">
								...
								<div class="table-responsive">
									<table class="w-100 table-hover table-bordered table-elements table-three-tr"cellpadding="2">
										<tr class="pt-5 table-three bg-dark text-white" style="height: 32px;">
					...
					<div class="col-lg-3 col-md-12">
						<div>
							<section class="mt-3">
								<div class="btn btn-block bg-info table-one text-light d-flex">
				...
				<div class="row">
					...
					<div class="table-responsive">
						<table class="w-100 table-striped table-hover table-bordered table-white"cellpadding="2" >
							<tr>
								<td colspan="12" class="text-center bg-info text-light"><h5>Attendance Report</h5></td>
							</tr>
